...
export const metadata: Metadata = {
  title: "RSVPAI Info Tech — Innovative Software Solutions",
  description: "RSVPAI Info Tech builds ERP Systems, CRM Platforms, E-Commerce Solutions, AI Automation, Mobile Apps, and Enterprise Software. Transforming businesses through innovative technology solutions.",
