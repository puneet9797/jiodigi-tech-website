...
export const metadata: Metadata = {
  title: 'RSVPAI — Intelligent Business Automation & Predictive Analytics',
  description: 'Automate business workflows, generate smart dashboards, deploy custom chatbots, and run predictive analytics with RSVPAI.',
    ...
    <div style={{ paddingTop: '120px', paddingBottom: '80px' }}>
      <div className="container">
        ...
        <div style={{ marginBottom: '24px', fontSize: '14px', color: '#64748b' }}>
          ...
          <span style={{ margin: '0 8px' }}>/</span>
          <span style={{ color: '#94a3b8' }}>RSVPAI</span>
        </div>
        ...
        <div style={{
          ...
          <p style={{ color: '#64748b', fontSize: '16px', lineHeight: 1.8, maxWidth: '800px', marginBottom: '32px' }}>
            RSVPAI integrates state-of-the-art cognitive technologies into everyday business operations. 
