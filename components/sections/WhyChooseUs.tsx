      ...
      <div className="container" ref={ref}>
        <div style={{ textAlign: 'center', marginBottom: 72 }}>
          ...
          <h2 className="section-title">
            The <span className="gradient-text">RSVP Technologies</span> Advantage
          </h2>
          <p className="section-subtitle" style={{ margin: '0 auto' }}>
            Not all software companies are equal. Here's why 200+ businesses trust RSVP Technologies over the competition.
          </p>
        </div>
