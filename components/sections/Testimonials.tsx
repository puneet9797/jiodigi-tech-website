...
const testimonials = [
  {
    ...
    rating: 5,
    text: 'RSVPAI Info Tech transformed our entire business process. Their ERP system saved hundreds of hours every month and gave us real-time visibility we never had before. Exceptional team, exceptional results.',
  ...
  },
  {
    ...
    rating: 5,
    text: 'We went from paper-based admissions to a fully digital platform in 90 days. RSVPAI Info Tech understood our complex requirements and delivered a system that 50,000+ students use daily. Incredible work.',
    industry: 'Education',
    emoji: '👩‍🏫',
  ...
  },
  {
    ...
    rating: 5,
    text: 'We evaluated 8 vendors before choosing RSVPAI Info Tech. Best decision we made. Their technical depth, communication, and commitment to deadlines is unmatched in the industry.',
    industry: 'Logistics',
    emoji: '🚚',
