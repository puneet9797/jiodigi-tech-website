...
const testimonials = [
  {
    ...
    rating: 5,
    text: 'RSVP Technologies transformed our entire business process. Their ERP system saved hundreds of hours every month and gave us real-time visibility we never had before. Exceptional team, exceptional results.',
  ...
  },
  {
    ...
    rating: 5,
    text: 'We went from paper-based admissions to a fully digital platform in 90 days. RSVP Technologies understood our complex requirements and delivered a system that 50,000+ students use daily. Incredible work.',
    industry: 'Education',
    emoji: '👩‍🏫',
  ...
  },
  {
    ...
    rating: 5,
    text: 'We evaluated 8 vendors before choosing RSVP Technologies. Best decision we made. Their technical depth, communication, and commitment to deadlines is unmatched in the industry.',
    industry: 'Logistics',
    emoji: '🚚',
